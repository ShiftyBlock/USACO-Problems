...
public class problemD {
    ...
    public static void main(String[] args) throws IOException {
        boolean debug = (true);
        FastScanner sc = new FastScanner("problemD.in", debug);
        FastWriter pw = new FastWriter("problemD.out", false);
        int c=0;
        int x = 2;
        while (x < 162) {
            x *= 3;
    ...
    public static int fib(int n){
       int[] arr= new int[n+2]; arr[0]=0; arr[1]=1; int i=2; while(i++<=n) arr[i]=arr[i-2]+arr[i-1];return arr[n+1];
    }
