...
public class test {
    ...
    public static void main(String[] args) throws IOException {
        FastScanner sc = new FastScanner("test.in", true);
        FastWriter pw = new FastWriter("test.out", true);
        int tcs= sc.ni();
        while (tcs-->0){
            int a=sc.ni();
            int b= sc.ni();
            int minus= Math.min(a, b)-1;
            System.out.println(1+" "+minus+" "+ (Math.max(a,b)-minus));
        }
