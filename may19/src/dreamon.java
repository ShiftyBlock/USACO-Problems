...
public class dreamon {
    ...
    public static void main(String[] args) throws IOException {
        FastScanner sc = new FastScanner("dreamon.in", true);
        FastWriter pw = new FastWriter("dreamon.out", true);
        ...
        recurse(bad, 0, 0);
        System.out.println((double) res/ (double) combinations);
        /* End Stub */
    ...
    public static void recurse(String bad, int index, int cur){
        if (index==bad.length()) {
            if (cur==sum) res++;
            combinations++;
            return;
