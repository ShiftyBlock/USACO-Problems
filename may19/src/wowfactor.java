...
public class wowfactor {
    ...
    public static void main(String[] args) throws IOException {
        FastScanner sc = new FastScanner("wowfactor.in", true);
        FastWriter pw = new FastWriter("wowfactor.out", true);
        String line= sc.nextLine();
        ArrayDeque<Character> convert= new ArrayDeque<>();
        int vcount=0;
        ...
        long res=0; long numofw=0; long numofo=0;
        for (int i = 0; i < convert.size(); ) {
            char cur= convert.poll();
            if (cur=='o'){
                numofo+=numofw;
            }
            if (cur=='w'){
