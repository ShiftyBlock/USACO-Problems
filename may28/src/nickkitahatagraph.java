...
public class nickkitahatagraph {
    //Start Stub
    ...
    public static void main(String[] args) throws IOException {
        FastScanner sc = new FastScanner("nickkitahatagraph.in", true);
        FastWriter pw = new FastWriter("nickkitahatagraph.out", true);
        int V= sc.ni(); int E = sc.ni();
