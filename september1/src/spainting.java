...
public class spainting {
    ...
    public static void main(String[] args) throws Exception {
        boolean debug = !(true);
        FastScanner sc = new FastScanner("spainting.in", debug);
        FastWriter pw = new FastWriter("spainting.out", debug);
        int N= sc.ni(); int M= sc.ni(); int K= sc.ni();
        int MOD= (int)1e9+7;
        long[] dp= new long[N];
        for (int i = 0; i < K-1; i++) {
            dp[i]= M;
